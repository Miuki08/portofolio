...
import AntiInspect from '../component/AntiInspect'; // Import AntiInspect
...
const projectsData = [
  {
    ...
    githubUrl: "https://github.com/Miuki08/merapatv2.0.1"
  },
  // {
  //   id: 2,
  //   title: "Kerja Kini",
  ...
  //   technologies: ["PHP", "My SQL", "Bootstrap"],
  //   category: "Web Development",
  //   githubUrl: "https://github.com/Miuki08/KerjaKini"
  // },
  // {
  //   id: 3,
  ...
  //   category: "Web Development",
  //   githubUrl: "https://github.com/Miuki08/azurareaweather"
  // },
  {
    id: 2,
    ...
    githubUrl: "https://github.com/Miuki08/android-jaya"
  },
  {
    id: 3,
    title: "Onebox Public Relation",
    description: "Onebox Public Relation membantu instansi pemerintah dan organisasi mengelola penerimaan informasi, distribusi berita, serta monitoring reputasi secara cepat, terpusat, dan akurat. ",
    image: "/projects/oneboxpr.png",
    technologies: ["PHP", "Phalcon", "My SQL", "Bootstrap"],
    category: "Web Development",
    // githubUrl: ""
  },
  {
    id: 4,
    title: "Portal TNI Angkatan Udara",
    description: "Portal informasi berbasis web untuk mendukung publikasi berita, dokumentasi kegiatan, dan penyebaran informasi resmi TNI Angkatan Udara.",
    image: "/projects/tniau.png",
...
export default function Projects() {
  ...
  return (
    <>
      {/* Anti Inspect dipanggil di sini */}
      <AntiInspect />
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Berikut adalah beberapa project yang telah aku kerjakan. Setiap project memiliki cerita dan tantangan nya masing - masing.
            </p>
          </div>
